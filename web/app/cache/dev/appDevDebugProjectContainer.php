...
class appDevDebugProjectContainer extends Container
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Klass\Bundle\UserBundle\Form\Type\RegistrationFormType A Klass\Bundle\UserBundle\Form\Type\RegistrationFormType instance.
     */
    protected function getApp_Form_RegistrationService()
    {
        return $this->services['app.form.registration'] = new \Klass\Bundle\UserBundle\Form\Type\RegistrationFormType();
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\TPM1Agile2\\Bundle\\UserBundle\\Entity'))), 'TPM1Agile2\\Bundle\\UserBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('TPM1Agile2UserBundle' => 'TPM1Agile2\\Bundle\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ceeefc325c48667ed40e136e1bbda368b79add707a04cbb27a095bfe89440cd5');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('TPM1Agile2\\Bundle\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('TPM1Agile2\\Bundle\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'devidea_user_registration', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('TPM1Agile2\\Bundle\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('TPM1Agile2\\Bundle\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'TPM1Agile2\\Bundle\\UserBundle\\Entity\\User');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/stats');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\TPM1Agile2\\Bundle\\UserBundle/Resources/views'), 'TPM1Agile2User');
        $instance->addPath(($this->targetDirs[3].'\\src\\TPM1Agile2\\Bundle\\FrontBundle/Resources/views'), 'TPM1Agile2Front');
        $instance->addPath(($this->targetDirs[3].'\\src\\TPM1Agile2\\Bundle\\BackBundle/Resources/views'), 'TPM1Agile2Back');
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_USER' => array(0 => 'ROLE_USER'), 'ROLE_ADMIN' => array(0 => 'ROLE_ADMIN'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TPM1Agile2UserBundle' => 'TPM1Agile2\\Bundle\\UserBundle\\TPM1Agile2UserBundle',
                'TPM1Agile2FrontBundle' => 'TPM1Agile2\\Bundle\\FrontBundle\\TPM1Agile2FrontBundle',
                'TPM1Agile2BackBundle' => 'TPM1Agile2\\Bundle\\BackBundle\\TPM1Agile2BackBundle',
            ...
            'fos_user.model.user.class' => 'TPM1Agile2\\Bundle\\UserBundle\\Entity\\User',
            ...
            'fos_user.registration.form.type' => 'devidea_user_registration',
