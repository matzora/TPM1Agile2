...
namespace Proxies\__CG__\TPM1Agile2\Bundle\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \TPM1Agile2\Bundle\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'gender', 'firstname', 'lastname', 'phone', 'licencePlate', 'status', 'structure', 'age', 'type', 'address', 'createDate', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function setCreatedValue()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCreatedValue', array());
    ...
    public function setLicencePlate($licencePlate)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLicencePlate', array($licencePlate));

        return parent::setLicencePlate($licencePlate);
    }
    ...
    public function getLicencePlate()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLicencePlate', array());

        return parent::getLicencePlate();
    }
     ...
     * {@inheritDoc}
     */
    public function setAddress(\TPM1Agile2\Bundle\UserBundle\Entity\Address $address)
    {
    ...
    public function setCreateDate(\DateTime $time)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCreateDate', array($time));

        return parent::setCreateDate($time);
    }
